...
namespace Lykke.Pay.Service.Invoces.Controllers
{
    ...
    public class InvoiceController : Controller
    {
        ...
        public async Task<IActionResult> CreateDraftAsync([FromBody]NewInvoiceModel model)
        {
        ...
        public async Task<IActionResult> UpdateDraftAsync([FromBody]InvoiceModel model)
        {
            if (!ModelState.IsValid)
                return BadRequest(ErrorResponse.Create("Invalid model.", ModelState));
        ...
        [ProducesResponseType(typeof(ErrorResponse), (int)HttpStatusCode.BadRequest)]
        [ProducesResponseType(typeof(ErrorResponse), (int)HttpStatusCode.NotFound)]
        public async Task<IActionResult> GenerateFromDraftAsync([FromBody]InvoiceModel model)
        {
            if (!ModelState.IsValid)
                return BadRequest(ErrorResponse.Create("Invalid model.", ModelState));
